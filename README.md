...
|---|---|---|---|
| 로또 머신 Lottie | 576x320 대지에 원본 Figma 이미지를 내장한 5초 루프 로또 머신 모션 | <a href="lotto-machine/index.html"><img src="lotto-machine/preview.gif" width="180" alt="로또 머신 미리보기"></a> | `lotto-machine/lottery-machine.json` |
...
| 동전 방사형 튀김 Lottie | 동전 5개가 손에서 튀어나오듯 짧게 방사형으로 흩어지는 모션 | <a href="coin-radial-throw/index.html"><img src="coin-radial-throw/preview-transparent.gif" width="160" alt="동전 방사형 튀김 미리보기"></a> | `coin-radial-throw/coin-radial-throw.json` |
