...
|---|---|---|---|
| 로또 머신 Lottie | 576x320 대지에 원본 Figma 이미지를 내장한 5초 루프 로또 머신 모션 | <a href="lotto-machine/index.html"><img src="lotto-machine/poster.png" width="180" alt="로또 머신 미리보기"></a> | `lotto-machine/lottery-machine.json` |
