...
|---|---|---|---|
| 로또 머신 Lottie | 로또 추첨기 구조와 공 움직임을 실험한 모션 | `lotto-machine/index.html` | `lotto-machine/lottery-machine.json` |
| 물방울형 폭죽 Lottie | 중심에서 핑크 톤 물방울 파편이 퍼지는 폭죽 모션 | `droplet-firework/index.html` | `droplet-firework/droplet-firework.json` |
